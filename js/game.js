...
function init() {
  ...
  // اختیاری: توقف حرکت وقتی دکمه رها می‌شه
  ...
  // برای لمس گوشی هم پشتیبانی اضافه کنیم:
  ['touchstart', 'click'].forEach(eventType => {
    document.getElementById('moveLeft').addEventListener(eventType, () => player.moveLeft());
    document.getElementById('moveRight').addEventListener(eventType, () => player.moveRight());
    document.getElementById('jump').addEventListener(eventType, () => player.jump());
    document.getElementById('shoot').addEventListener(eventType, () => player.shoot());
  });
